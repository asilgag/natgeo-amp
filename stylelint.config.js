module.exports = {
  ...
  ignoreFiles: ['src/assets/fonts/dp-icons/*.scss'],
  rules: {
    // at-rule
    ...
    // 'declaration-block-trailing-semicolon': 'never', // https://stylelint.io/user-guide/rules/declaration-block-trailing-semicolon/
    ...
    // 'no-missing-end-of-source-newline': false, // https://stylelint.io/user-guide/rules/no-missing-end-of-source-newline/
    ...
    'no-eol-whitespace': [
      true, // https://stylelint.io/user-guide/rules/no-eol-whitespace/
      {
        ignore: ['empty-lines'],
      },
    ],
